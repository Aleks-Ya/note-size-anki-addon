...
class CacheInitializer:
    def __init__(self, mw: AnkiQt, media_cache: MediaCache, item_id_cache: ItemIdCache,
                 size_calculator: SizeCalculator, cache_storage: CacheStorage, config: Config) -> None:
        self.__mw: AnkiQt = mw
    ...
    def initialize_caches(self) -> None:
        CacheInitializerOp(self.__mw, self.__media_cache, self.__item_id_cache, self.__size_calculator, self.__config,
