...
class _WarmupCacheOp:
    ...
    def warmup_caches_in_background(self):
        if self.__config.get_cache_warmup_enabled():
            ...
            QueryOp(parent=self.__parent, op=self.__background_op,
                    success=self.__on_success).with_progress().run_in_background()
        else:
...
class CacheUpdater:
    ...
    def initialize_caches(self):
        ...
        _WarmupCacheOp(self.__media_cache, self.__item_id_cache, self.__config, mw).warmup_caches_in_background()
    ...
    def refresh_caches(self, parent: QWidget):
        ...
        _WarmupCacheOp(self.__media_cache, self.__item_id_cache, self.__config,
                       parent).with_on_refresh_success().warmup_caches_in_background()
