...
class SizeCalculator(Cache):
    ...
    def as_dict_list(self) -> list[dict[Any, Any]]:
        return [self.__note_total_size_cache, self.__note_note_texts_size, self.__note_files_cache,
                self.__note_file_sizes_cache]
    ...
    def read_from_dict_list(self, caches: list[dict[Any, Any]]):
        with self._lock:
            ...
            self.__note_files_cache = caches[2]
            self.__note_file_sizes_cache = caches[3]
