...
def test_parse_levels(level_parser: LevelParser):
    levels_dict: list[LevelDict] = [
        LevelDict({"Color": Colors.pale_green, "Max Size": "100 KB"}),
        LevelDict({"Color": Colors.orange, "Max Size": "1 MB"}),
        LevelDict({"Color": Colors.light_coral, "Max Size": None})]
...
def test_parse_levels_single(level_parser: LevelParser):
    levels_dict: list[LevelDict] = [
        LevelDict({"Color": Colors.pale_green, "Max Size": None})]
    levels: list[Level] = level_parser.parse_levels(levels_dict)
    assert levels == [
...
def test_add_level(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {"Color": Colors.pale_green, "Max Size": "100 KB"},
        {"Color": Colors.orange, "Max Size": "1 MB"},
        {"Color": Colors.light_coral, "Max Size": "2 MB"},
        {"Color": Colors.yellow, "Max Size": None}]
...
def test_add_level_to_two(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {"Color": Colors.pale_green, "Max Size": "100 KB"},
        {"Color": Colors.light_coral, "Max Size": "200 KB"},
        {"Color": Colors.yellow, "Max Size": None}]
...
def test_remove_level_middle(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {"Color": Colors.pale_green, "Max Size": "100 KB"},
        {"Color": Colors.light_coral, "Max Size": None}]
...
def test_remove_level_last(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {"Color": Colors.pale_green, "Max Size": "100 KB"},
        {"Color": Colors.orange, "Max Size": None}]
