...
def test_parse_levels(level_parser: LevelParser):
    levels_dict: list[LevelDict] = [
        LevelDict({LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": "100 KB"}),
        LevelDict({LevelParser.light_theme_color_key: Colors.orange, "Max Size": "1 MB"}),
        LevelDict({LevelParser.light_theme_color_key: Colors.light_coral, "Max Size": None})]
    levels: list[Level] = level_parser.parse_levels(levels_dict)
    assert levels == [
        Level(Colors.pale_green, None,
              SizeBytes(0), SizeBytes(102_400), SizeStr("0 B"), SizeStr("100 KB")),
        Level(Colors.orange, None,
              SizeBytes(102_400), SizeBytes(1_048_576), SizeStr("100 KB"), SizeStr("1 MB")),
        Level(Colors.light_coral, None,
...
def test_parse_levels_single(level_parser: LevelParser):
    levels_dict: list[LevelDict] = [
        LevelDict({LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": None})]
    levels: list[Level] = level_parser.parse_levels(levels_dict)
    assert levels == [
        Level(Colors.pale_green, None, SizeBytes(0), SizeBytes(sys.maxsize), SizeStr("0 B"), SizeStr("∞"))
    ]
...
def test_add_level(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": "100 KB"},
        {LevelParser.light_theme_color_key: Colors.orange, "Max Size": "1 MB"},
        {LevelParser.light_theme_color_key: Colors.light_coral, "Max Size": "2 MB"},
        {LevelParser.light_theme_color_key: Colors.yellow,
         LevelParser.dark_theme_color_key: Colors.light_yellow, "Max Size": None}]
...
def test_add_level_to_two(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": "100 KB"},
        {LevelParser.light_theme_color_key: Colors.light_coral, "Max Size": "200 KB"},
        {LevelParser.light_theme_color_key: Colors.yellow,
         LevelParser.dark_theme_color_key: Colors.light_yellow, "Max Size": None}]
...
def test_remove_level_middle(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": "100 KB"},
        {LevelParser.light_theme_color_key: Colors.light_coral, "Max Size": None}]
...
def test_remove_level_last(level_parser: LevelParser):
    ...
    assert levels_dict == [
        {LevelParser.light_theme_color_key: Colors.pale_green, "Max Size": "100 KB"},
        {LevelParser.light_theme_color_key: Colors.orange, "Max Size": None}]
