...
def test_format_note_detailed_text(td: Data, module_dir: Path, details_formatter: DetailsFormatter):
    ...
    exp_html: str = f"""
        ...
        <ol>
            <li style="white-space:nowrap">
                <img alt="Image file" height="15" src="{module_dir}/button/icon/image.png" style="vertical-align: middle;"/>
            ...
            <li style="white-space:nowrap">
                <img alt="Audio file" height="15" src="{module_dir}/button/icon/audio.png" style="vertical-align: middle;"/>
...
def test_format_note_with_single_missing_file(td: Data, module_dir: Path, details_formatter: DetailsFormatter):
    note: Note = td.create_note_without_files()
...
def test_unrecognized_mime_type(td: Data, module_dir: Path, details_formatter: DetailsFormatter):
    ...
    exp_html: str = f"""
        ...
        <ol>
            <li style="white-space:nowrap">
                <img alt="Other file"  height="15" src="{module_dir}/button/icon/other.png" style="vertical-align: middle;"/>
...
def test_limit_showed_number_of_files(td: Data, module_dir: Path, details_formatter: DetailsFormatter):
...
def test_limit_showed_number_of_files_exact(td: Data, module_dir: Path, details_formatter: DetailsFormatter):
