...
def test_show_notes_size(browser_button_manager: BrowserButtonManager, td: Data):
...
def test_show_cards_size(col: Collection, browser_button_manager: BrowserButtonManager, td: Data):
    button: BrowserButton = browser_button_manager.create_browser_button()
    note1: Note = td.create_note_with_files()
    note2: Note = td.create_note_without_files()
